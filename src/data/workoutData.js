export const EXERCISES = {
    gym: {
        ...
        legs: [
            ...
            { id: 'g_lg_5', name: 'Terra Romeno (Barra)', muscle: 'Pernas', sets: 4, reps: '10', tier: 1, howTo: 'Pernas quase estendidas, desça a barra rente às pernas jogando o quadril para trás.', proTip: 'Sinta o alongamento dos posteriores, não use a lombar.', muscles: { primary: ['Isquiotibiais', 'Glúteo'], secondary: ['Eretores da Espinha'] } },
