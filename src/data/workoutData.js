export const EXERCISES = {
    gym: {
        ...
        shoulders: [
            ...
            { id: 'g_sh_6', name: 'Face Pull (Corda)', muscle: 'Ombros', sets: 3, reps: '15-20', tier: 3, howTo: 'Polia na altura dos olhos, puxe a corda em direção ao rosto abrindo os cotovelos para fora.', proTip: 'Essencial para saúde dos ombros e rotadores externos. Não negligencie este exercício.', muscles: { primary: ['Deltoide Posterior', 'Rotadores Externos'], secondary: ['Trapézio Médio'] } },
            { id: 'g_sh_7', name: 'Arnold Press', muscle: 'Ombros', sets: 3, reps: '10-12', tier: 2, howTo: 'Inicie com palmas voltadas para você, rotacione os halteres enquanto sobe até as palmas ficarem para fora.', proTip: 'Recruta os três feixes do deltoide em um único movimento composto.', muscles: { primary: ['Deltoide Frontal', 'Deltoide Lateral'], secondary: ['Tríceps'] } },
        ...
        triceps: [
            ...
            { id: 'g_tr_6', name: 'Kickback (Halter)', muscle: 'Tríceps', sets: 3, reps: '12-15', tier: 3, howTo: 'Inclinado com o tronco paralelo ao chão, mantenha o cotovelo fixo e estenda o braço para trás.', proTip: 'Foco total na contração de pico no final do movimento.', muscles: { primary: ['Tríceps (Cabeça Lateral)'] } }
        ],
        biceps: [
        ...
        core: [
            ...
            { id: 'g_co_4', name: 'Roda Abdominal', muscle: 'Abs', sets: 3, reps: '10', tier: 1, howTo: 'Ajoelhado com a roda no chão, estenda o corpo para frente de forma controlada e retorne puxando o core.', proTip: 'Um dos exercícios mais eficientes para o core. Comece com amplitude parcial se necessário.', muscles: { primary: ['Reto Abdominal', 'Core'], secondary: ['Ombros'] } },
            { id: 'g_co_5', name: 'Abdominal Declinado', muscle: 'Abs', sets: 4, reps: '15-20', tier: 2, howTo: 'No banco declinado, suba o tronco de forma controlada até 45 graus.', proTip: 'Adicione uma anilha no peito para progredir com sobrecarga.', muscles: { primary: ['Reto Abdominal'] } }
        ],
        forearms: [
